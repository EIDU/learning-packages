...
class LearningAppVersionTest {
    ...
    fun `fromString converts from string`() =
        assertThat(LearningAppVersion.fromString("$APP_ID:$VERSION")).isEqualTo(APP_VERSION)

    @Test
    fun `serializes and deserializes`() = assertSerializationIsStable(APP_VERSION)

    companion object {
        private val APP_VERSION = LearningAppVersion("app", "version")
